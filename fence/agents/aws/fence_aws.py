...
def define_new_opts():
	...
	all_opt["accesskey"] = {
		"getopt" : "a:",
		"longopt" : "accesskey",
		"help" : "-a, --accesskey=[name]         Access Key",
	...
	all_opt["secretkey"] = {
		"getopt" : "s:",
		"longopt" : "secretkey",
		"help" : "-s, --secretkey=[name]         Secret Key",
...
def main():
	...
	device_opt = ["port", "no_password", "region", "accesskey", "secretkey"]
...
For instructions see: https://boto3.readthedocs.io/en/latest/guide/quickstart.html#configuration"
	...
	if "--region" in options and "--accesskey" in options and "--secretkey" in options:  
